...
public class AvailableCommands extends soupply.bedrock.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock.type.Enum z5bm:enums)
        {
            z5bm.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)commands.length);
        for(soupply.bedrock.type.Command y9bfzm:commands)
        {
