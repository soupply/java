...
public class BookEdit extends soupply.bedrock.Packet
{
    ...
    public class ReplacePage extends soupply.bedrock.Packet
    {
    ...
    public class AddPage extends soupply.bedrock.Packet
    {
    ...
    public class DeletePage extends soupply.bedrock.Packet
    {
    ...
    public class SwapPages extends soupply.bedrock.Packet
    {
    ...
    public class Sign extends soupply.bedrock.Packet
    {
