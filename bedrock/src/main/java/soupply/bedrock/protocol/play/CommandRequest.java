...
public class CommandRequest extends soupply.bedrock.Packet
{
    ...
    public CommandRequest(String command, int type, soupply.bedrock.type.McpeUuid uuid, String requestId, int playerId, boolean internal)
    {
