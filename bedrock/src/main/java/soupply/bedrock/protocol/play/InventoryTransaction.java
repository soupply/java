...
public class InventoryTransaction extends soupply.bedrock.Packet
{
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        actions = new soupply.bedrock.type.InventoryAction[bfdlbm];
    ...
    public class Normal0 extends soupply.bedrock.Packet
    {
    ...
    public class Normal1 extends soupply.bedrock.Packet
    {
    ...
    public class UseItem extends soupply.bedrock.Packet
    {
        ...
        public soupply.bedrock.type.BlockPosition blockPosition;
        public int face;
        ...
        public UseItem()
        {
            this.blockPosition = new soupply.bedrock.type.BlockPosition();
            this.item = new soupply.bedrock.type.Slot();
            this.playerPosition = new FloatXYZ();
            this.clickPosition = new FloatXYZ();
        }

        public UseItem(int actionType, soupply.bedrock.type.BlockPosition blockPosition, int face, int hotbarSlot, soupply.bedrock.type.Slot item, FloatXYZ playerPosition, FloatXYZ clickPosition)
        {
    ...
    public class UseItemOnEntity extends soupply.bedrock.Packet
    {
        ...
        public UseItemOnEntity(long entityId, int actionType, int hotbarSlot, soupply.bedrock.type.Slot item, FloatXYZ unknown4, FloatXYZ unknown5)
        {
    ...
    public class ReleaseItem extends soupply.bedrock.Packet
    {
        ...
        public ReleaseItem(int actionType, int hotbarSlot, soupply.bedrock.type.Slot item, FloatXYZ headPosition)
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
