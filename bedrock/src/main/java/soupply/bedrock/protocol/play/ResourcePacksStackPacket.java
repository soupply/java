...
class ResourcePacksStackPacket extends soupply.bedrock.Packet
{
    ...
    {
        this.behaviourPacks = new soupply.bedrock.type.Pack[]();
        this.resourcePacks = new soupply.bedrock.type.Pack[]();
    }
