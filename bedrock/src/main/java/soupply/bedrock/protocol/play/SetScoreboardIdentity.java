...
public class SetScoreboardIdentity extends soupply.bedrock.Packet
{
    ...
    public byte type;
    public soupply.bedrock.type.RegisterEntry[] registerEntries;
    ...
    public SetScoreboardIdentity(byte type, soupply.bedrock.type.RegisterEntry[] registerEntries, long[] clearEntries)
    {
        this.type = type;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        if(type==0)
        {
            ...
            for(soupply.bedrock.type.RegisterEntry cvanzjbr:registerEntries)
            {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        if(type==0)
        {
            ...
            registerEntries = new soupply.bedrock.type.RegisterEntry[bjzldvr5];
