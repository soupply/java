...
public class Text extends soupply.bedrock.Packet
{
    ...
    public class Raw extends soupply.bedrock.Packet
    {
    ...
    public class Chat extends soupply.bedrock.Packet
    {
    ...
    public class Translation extends soupply.bedrock.Packet
    {
    ...
    public class Popup extends soupply.bedrock.Packet
    {
    ...
    public class JukeboxPopup extends soupply.bedrock.Packet
    {
    ...
    public class Tip extends soupply.bedrock.Packet
    {
    ...
    public class System extends soupply.bedrock.Packet
    {
    ...
    public class Whisper extends soupply.bedrock.Packet
    {
    ...
    public class Announcement extends soupply.bedrock.Packet
    {
