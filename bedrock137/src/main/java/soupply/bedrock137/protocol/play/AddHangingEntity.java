...
public class AddHangingEntity extends soupply.bedrock137.Packet
{
    ...
    public AddHangingEntity(long entityId, long runtimeId, soupply.bedrock137.type.BlockPosition position, int unknown3)
    {
