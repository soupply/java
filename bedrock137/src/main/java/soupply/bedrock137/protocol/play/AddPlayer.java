...
public class AddPlayer extends soupply.bedrock137.Packet
{
    ...
    public float yaw;
    public soupply.bedrock137.type.Slot heldItem;
    ...
    public AddPlayer(soupply.bedrock137.type.McpeUuid uuid, String username, long entityId, long runtimeId, FloatXYZ position, FloatXYZ motion, float pitch, float headYaw, float yaw, soupply.bedrock137.type.Slot heldItem, soupply.bedrock137.metadata.Metadata metadata, int unknown11, int unknown12, int unknown13, int unknown14, int unknown15, long unknown16, soupply.bedrock137.type.Link[] links)
    {
        this.uuid = uuid;
