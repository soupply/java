...
public class AvailableCommands extends soupply.bedrock137.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.Enum z5bm:enums)
        {
            z5bm.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)commands.length);
        for(soupply.bedrock137.type.Command y9bfzm:commands)
        {
