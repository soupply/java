...
public class ClientboundMapItemData extends soupply.bedrock137.Packet
{
    ...
    public ClientboundMapItemData(long mapId, int update, byte scale, IntXZ size, IntXZ offset, byte[] data, soupply.bedrock137.type.Decoration[] decorations)
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.Decoration zvbjdlbm:decorations)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        decorations = new soupply.bedrock137.type.Decoration[bry9yrb5];
