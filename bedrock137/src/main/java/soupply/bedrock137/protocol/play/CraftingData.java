...
public class CraftingData extends soupply.bedrock137.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.Recipe cvabc:recipes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        recipes = new soupply.bedrock137.type.Recipe[bjylzm];
