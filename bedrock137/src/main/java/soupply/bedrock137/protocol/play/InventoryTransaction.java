...
public class InventoryTransaction extends soupply.bedrock137.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.InventoryAction yna9c:actions)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        actions = new soupply.bedrock137.type.InventoryAction[bfdlbm];
    ...
    public class Normal0 extends soupply.bedrock137.Packet
    {
    ...
    public class Normal1 extends soupply.bedrock137.Packet
    {
    ...
    public class UseItem extends soupply.bedrock137.Packet
    {
        ...
        public soupply.bedrock137.type.BlockPosition blockPosition;
        public int face;
        ...
        public UseItem()
        {
            this.blockPosition = new soupply.bedrock137.type.BlockPosition();
            this.item = new soupply.bedrock137.type.Slot();
            this.playerPosition = new FloatXYZ();
            this.clickPosition = new FloatXYZ();
        }

        public UseItem(int actionType, soupply.bedrock137.type.BlockPosition blockPosition, int face, int hotbarSlot, soupply.bedrock137.type.Slot item, FloatXYZ playerPosition, FloatXYZ clickPosition)
        {
    ...
    public class UseItemOnEntity extends soupply.bedrock137.Packet
    {
        ...
        public UseItemOnEntity(long entityId, int actionType, int hotbarSlot, soupply.bedrock137.type.Slot item, FloatXYZ unknown4, FloatXYZ unknown5)
        {
    ...
    public class ReleaseItem extends soupply.bedrock137.Packet
    {
        ...
        public ReleaseItem(int actionType, int hotbarSlot, soupply.bedrock137.type.Slot item, FloatXYZ headPosition)
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
