...
public class ResourcePacksInfo extends soupply.bedrock137.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.PackWithSize yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeLittleEndianShort((short)resourcePacks.length);
        for(soupply.bedrock137.type.PackWithSize cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        behaviourPacks = new soupply.bedrock137.type.PackWithSize[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock137.type.PackWithSize[bjc9cnuf];
