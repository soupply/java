...
public class ResourcePacksStackPacket extends soupply.bedrock137.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.Pack yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)resourcePacks.length);
        for(soupply.bedrock137.type.Pack cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        behaviourPacks = new soupply.bedrock137.type.Pack[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock137.type.Pack[bjc9cnuf];
