...
public class ChunkData extends Type
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock137.type.Section cvdlbm:sections)
        {
        ...
        for(soupply.bedrock137.type.ExtraData zhcfyr:extraData)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        sections = new soupply.bedrock137.type.Section[bnyrb5];
        ...
        extraData = new soupply.bedrock137.type.ExtraData[bvdjrfy];
