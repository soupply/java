...
public class Command extends Type
{
    ...
    public soupply.bedrock137.type.Overload[] overloads;

    public Command()
    {
    }

    public Command(String name, String description, byte unknown2, byte permissionLevel, int aliasesEnum, soupply.bedrock137.type.Overload[] overloads)
    {
        this.name = name;
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        overloads = new soupply.bedrock137.type.Overload[b9zjbfc];
