...
public class ClientboundMapItemData extends soupply.bedrock141.Packet
{
    ...
    public ClientboundMapItemData(long mapId, int update, byte scale, IntXZ size, IntXZ offset, byte[] data, soupply.bedrock141.type.Decoration[] decorations)
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        if(update==4)
        {
            ...
            decorations = new soupply.bedrock141.type.Decoration[bry9yrb5];
