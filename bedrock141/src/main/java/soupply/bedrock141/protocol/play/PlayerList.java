...
public class PlayerList extends soupply.bedrock141.Packet
{
    ...
    public class Add extends soupply.bedrock141.Packet
    {

        public soupply.bedrock141.type.PlayerList[] players;

        public Add()
        {
        }

        public Add(soupply.bedrock141.type.PlayerList[] players)
        {
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            for(soupply.bedrock141.type.PlayerList cxevc:players)
            {
    ...
    public class Remove extends soupply.bedrock141.Packet
    {

        public soupply.bedrock141.type.McpeUuid[] players;

        public Remove()
        {
        }

        public Remove(soupply.bedrock141.type.McpeUuid[] players)
        {
            this.players = players;
        }
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            encodeMainBody(_buffer);
            _buffer.writeVaruint((int)players.length);
            for(soupply.bedrock141.type.McpeUuid cxevc:players)
            {
                cxevc.encodeBody(_buffer);
            }
        }
