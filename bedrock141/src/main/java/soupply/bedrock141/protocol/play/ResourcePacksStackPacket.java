...
public class ResourcePacksStackPacket extends soupply.bedrock141.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock141.type.Pack yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)resourcePacks.length);
        for(soupply.bedrock141.type.Pack cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        behaviourPacks = new soupply.bedrock141.type.Pack[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock141.type.Pack[bjc9cnuf];
