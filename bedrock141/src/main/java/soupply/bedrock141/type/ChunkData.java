...
public class ChunkData extends Type
{
    ...
    private void encodeBodyImpl(Buffer _buffer)
    {
        ...
        for(soupply.bedrock141.type.Section cvdlbm:sections)
        {
        ...
        for(soupply.bedrock141.type.ExtraData zhcfyr:extraData)
        {
    ...
    private void decodeBodyImpl(Buffer _buffer) throws BufferOverflowException
    {
        ...
        sections = new soupply.bedrock141.type.Section[bnyrb5];
        ...
        extraData = new soupply.bedrock141.type.ExtraData[bvdjrfy];
