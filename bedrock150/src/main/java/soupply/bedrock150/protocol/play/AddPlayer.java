...
public class AddPlayer extends soupply.bedrock150.Packet
{
    ...
    public AddPlayer(soupply.bedrock150.type.McpeUuid uuid, String username, long entityId, long runtimeId, FloatXYZ position, FloatXYZ motion, float pitch, float headYaw, float yaw, soupply.bedrock150.type.Slot heldItem, soupply.bedrock150.metadata.Metadata metadata, int unknown11, int unknown12, int unknown13, int unknown14, int unknown15, long unknown16, soupply.bedrock150.type.Link[] links)
    {
        this.uuid = uuid;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock150.type.Link blam:links)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        links = new soupply.bedrock150.type.Link[bxbt];
