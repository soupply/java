...
public class InventoryTransaction extends soupply.bedrock150.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock150.type.InventoryAction yna9c:actions)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        actions = new soupply.bedrock150.type.InventoryAction[bfdlbm];
    ...
    public class Normal0 extends soupply.bedrock150.Packet
    {
    ...
    public class Normal1 extends soupply.bedrock150.Packet
    {
    ...
    public class UseItem extends soupply.bedrock150.Packet
    {
        ...
        public soupply.bedrock150.type.BlockPosition blockPosition;
        public int face;
        ...
        public UseItem()
        {
            this.blockPosition = new soupply.bedrock150.type.BlockPosition();
            this.item = new soupply.bedrock150.type.Slot();
            this.playerPosition = new FloatXYZ();
            this.clickPosition = new FloatXYZ();
        }

        public UseItem(int actionType, soupply.bedrock150.type.BlockPosition blockPosition, int face, int hotbarSlot, soupply.bedrock150.type.Slot item, FloatXYZ playerPosition, FloatXYZ clickPosition)
        {
    ...
    public class UseItemOnEntity extends soupply.bedrock150.Packet
    {
        ...
        public UseItemOnEntity(long entityId, int actionType, int hotbarSlot, soupply.bedrock150.type.Slot item, FloatXYZ unknown4, FloatXYZ unknown5)
        {
    ...
    public class ReleaseItem extends soupply.bedrock150.Packet
    {
        ...
        public ReleaseItem(int actionType, int hotbarSlot, soupply.bedrock150.type.Slot item, FloatXYZ headPosition)
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
