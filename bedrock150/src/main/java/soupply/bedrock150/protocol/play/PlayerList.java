...
public class PlayerList extends soupply.bedrock150.Packet
{
    ...
    public class Add extends soupply.bedrock150.Packet
    {
        ...
        public Add(soupply.bedrock150.type.PlayerList[] players)
        {
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            for(soupply.bedrock150.type.PlayerList cxevc:players)
            {
        ...
        public void decodeBody(Buffer _buffer)
        {
            ...
            players = new soupply.bedrock150.type.PlayerList[bbylcm];
    ...
    public class Remove extends soupply.bedrock150.Packet
    {
        ...
        public Remove(soupply.bedrock150.type.McpeUuid[] players)
        {
            this.players = players;
        }
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            encodeMainBody(_buffer);
            _buffer.writeVaruint((int)players.length);
            for(soupply.bedrock150.type.McpeUuid cxevc:players)
            {
                cxevc.encodeBody(_buffer);
            }
        }
        ...
        {
            final int bbylcm = _buffer.readVaruint();
            players = new soupply.bedrock150.type.McpeUuid[bbylcm];
            for(int cxevc=0;cxevc<players.length;cxevc++)
            {
                players[cxevc].decodeBody(_buffer);
            }
