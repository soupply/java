...
public class ResourcePacksInfo extends soupply.bedrock150.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock150.type.PackWithSize yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeLittleEndianShort((short)resourcePacks.length);
        for(soupply.bedrock150.type.PackWithSize cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        behaviourPacks = new soupply.bedrock150.type.PackWithSize[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock150.type.PackWithSize[bjc9cnuf];
