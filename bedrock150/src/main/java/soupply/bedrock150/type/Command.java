...
public class Command extends Type
{
    ...
    public soupply.bedrock150.type.Overload[] overloads;

    public Command()
    {
    }

    public Command(String name, String description, byte unknown2, byte permissionLevel, int aliasesEnum, soupply.bedrock150.type.Overload[] overloads)
    {
        this.name = name;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock150.type.Overload bzcxyr:overloads)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        overloads = new soupply.bedrock150.type.Overload[b9zjbfc];
