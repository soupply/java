...
public class CommandRequest extends soupply.bedrock160.Packet
{
    ...
    public CommandRequest(String command, int type, soupply.bedrock160.type.McpeUuid uuid, String requestId, int playerId, boolean internal)
    {
