...
public class StartGame extends soupply.bedrock160.Packet
{
    ...
    public soupply.bedrock160.type.Rule[] gameRules;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock160.type.Rule zfzjbv:gameRules)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        gameRules = new soupply.bedrock160.type.Rule[bdbvdxc];
