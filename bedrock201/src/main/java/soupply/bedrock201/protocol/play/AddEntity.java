...
public class AddEntity extends soupply.bedrock201.Packet
{
    ...
    public AddEntity(long entityId, long runtimeId, int type, FloatXYZ position, FloatXYZ motion, float pitch, float yaw, soupply.bedrock201.type.Attribute[] attributes, soupply.bedrock201.metadata.Metadata metadata, soupply.bedrock201.type.Link[] links)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock201.type.Attribute yrcldrc:attributes)
        {
            yrcldrc.encodeBody(_buffer);
        }
        metadata.encodeBody(_buffer);
        _buffer.writeVaruint((int)links.length);
        for(soupply.bedrock201.type.Link blam:links)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        links = new soupply.bedrock201.type.Link[bxbt];
