...
public class InventoryTransaction extends soupply.bedrock201.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock201.type.InventoryAction yna9c:actions)
        {
    ...
    public class Normal0 extends soupply.bedrock201.Packet
    {
    ...
    public class Normal1 extends soupply.bedrock201.Packet
    {
    ...
    public class UseItem extends soupply.bedrock201.Packet
    {
        ...
        public soupply.bedrock201.type.BlockPosition blockPosition;
        public int face;
        ...
        public UseItem()
        {
            this.blockPosition = new soupply.bedrock201.type.BlockPosition();
            this.item = new soupply.bedrock201.type.Slot();
            this.playerPosition = new FloatXYZ();
            this.clickPosition = new FloatXYZ();
        }

        public UseItem(int actionType, soupply.bedrock201.type.BlockPosition blockPosition, int face, int hotbarSlot, soupply.bedrock201.type.Slot item, FloatXYZ playerPosition, FloatXYZ clickPosition)
        {
    ...
    public class UseItemOnEntity extends soupply.bedrock201.Packet
    {
        ...
        public UseItemOnEntity(long entityId, int actionType, int hotbarSlot, soupply.bedrock201.type.Slot item, FloatXYZ unknown4, FloatXYZ unknown5)
        {
    ...
    public class ReleaseItem extends soupply.bedrock201.Packet
    {
        ...
        public ReleaseItem(int actionType, int hotbarSlot, soupply.bedrock201.type.Slot item, FloatXYZ headPosition)
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
