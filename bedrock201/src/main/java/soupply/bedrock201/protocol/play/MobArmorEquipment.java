...
public class MobArmorEquipment extends soupply.bedrock201.Packet
{
    ...
    {
        this.armor = new soupply.bedrock201.type.Slot[4];
    }
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock201.type.Slot yjbi:armor)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        armor = new soupply.bedrock201.type.Slot[bfb9];
