...
public class ChunkData extends Type
{
    ...
    public byte[] biomes;
    public byte[] borders;
    public soupply.bedrock201.type.ExtraData[] extraData;
    ...
    public ChunkData(soupply.bedrock201.type.Section[] sections, short[] heights, byte[] biomes, byte[] borders, soupply.bedrock201.type.ExtraData[] extraData, byte[] blockEntities)
    {
    ...
    private void encodeBodyImpl(Buffer _buffer)
    {
        ...
        for(soupply.bedrock201.type.Section cvdlbm:sections)
        {
        ...
        for(soupply.bedrock201.type.ExtraData zhcfyr:extraData)
        {
