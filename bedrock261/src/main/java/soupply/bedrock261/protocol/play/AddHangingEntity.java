...
public class AddHangingEntity extends soupply.bedrock261.Packet
{
    ...
    public AddHangingEntity(long entityId, long runtimeId, soupply.bedrock261.type.BlockPosition position, int unknown3)
    {
