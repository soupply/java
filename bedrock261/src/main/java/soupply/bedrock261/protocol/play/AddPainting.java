...
public class AddPainting extends soupply.bedrock261.Packet
{
    ...
    public AddPainting(long entityId, long runtimeId, soupply.bedrock261.type.BlockPosition position, int direction, String title)
    {
