...
public class AvailableCommands extends soupply.bedrock261.Packet
{
    ...
    public soupply.bedrock261.type.Enum[] enums;
    public soupply.bedrock261.type.Command[] commands;

    public AvailableCommands()
    {
    }

    public AvailableCommands(String[] enumValues, String[] unknown1, soupply.bedrock261.type.Enum[] enums, soupply.bedrock261.type.Command[] commands)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock261.type.Enum z5bm:enums)
        {
            z5bm.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)commands.length);
        for(soupply.bedrock261.type.Command y9bfzm:commands)
        {
