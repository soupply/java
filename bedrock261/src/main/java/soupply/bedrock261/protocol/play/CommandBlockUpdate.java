...
public class CommandBlockUpdate extends soupply.bedrock261.Packet
{
    ...
    public CommandBlockUpdate(boolean updateBlock, soupply.bedrock261.type.BlockPosition position, int mode, boolean redstoneMode, boolean conditional, long minecart, String command, String lastOutput, String hover, boolean trackOutput)
    {
