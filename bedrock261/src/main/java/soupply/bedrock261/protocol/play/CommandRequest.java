...
public class CommandRequest extends soupply.bedrock261.Packet
{
    ...
    public CommandRequest(String command, int type, soupply.bedrock261.type.McpeUuid uuid, String requestId, int playerId, boolean internal)
    {
