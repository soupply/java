...
public class FullChunkData extends soupply.bedrock261.Packet
{

    public static final int ID = 58;

    public IntXZ position;
    public soupply.bedrock261.type.ChunkData data;

    public FullChunkData()
    {
        this.position = new IntXZ();
        this.data = new soupply.bedrock261.type.ChunkData();
    }

    public FullChunkData(IntXZ position, soupply.bedrock261.type.ChunkData data)
    {
