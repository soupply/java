...
public class MobEquipment extends soupply.bedrock261.Packet
{
    ...
    public MobEquipment(long entityId, soupply.bedrock261.type.Slot item, byte inventorySlot, byte hotbarSlot, byte unknown4)
    {
