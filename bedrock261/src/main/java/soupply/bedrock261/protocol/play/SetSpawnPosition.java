...
public class SetSpawnPosition extends soupply.bedrock261.Packet
{
    ...
    public SetSpawnPosition(int type, soupply.bedrock261.type.BlockPosition position, boolean forced)
    {
        this.type = type;
