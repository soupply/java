...
public class ChunkData extends Type
{
    ...
    public soupply.bedrock261.type.Section[] sections;
    public short[] heights;
    public byte[] biomes;
    public byte[] borders;
    public soupply.bedrock261.type.ExtraData[] extraData;
    ...
    public ChunkData(soupply.bedrock261.type.Section[] sections, short[] heights, byte[] biomes, byte[] borders, soupply.bedrock261.type.ExtraData[] extraData, byte[] blockEntities)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock261.type.Section cvdlbm:sections)
        {
        ...
        for(soupply.bedrock261.type.ExtraData zhcfyr:extraData)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        sections = new soupply.bedrock261.type.Section[bnyrb5];
        ...
        extraData = new soupply.bedrock261.type.ExtraData[bvdjrfy];
