...
public class AddPainting extends soupply.bedrock274.Packet
{
    ...
    public AddPainting(long entityId, long runtimeId, soupply.bedrock274.type.BlockPosition position, int direction, String title)
    {
