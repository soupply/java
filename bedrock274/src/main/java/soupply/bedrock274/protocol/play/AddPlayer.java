...
public class AddPlayer extends soupply.bedrock274.Packet
{
    ...
    public float yaw;
    public soupply.bedrock274.type.Slot heldItem;
    ...
    public AddPlayer()
    {
        ...
        this.heldItem = new soupply.bedrock274.type.Slot();
        this.metadata = new soupply.bedrock274.metadata.Metadata();
    }

    public AddPlayer(soupply.bedrock274.type.McpeUuid uuid, String username, long entityId, long runtimeId, FloatXYZ position, FloatXYZ motion, float pitch, float headYaw, float yaw, soupply.bedrock274.type.Slot heldItem, soupply.bedrock274.metadata.Metadata metadata, int unknown11, int unknown12, int unknown13, int unknown14, int unknown15, long unknown16, soupply.bedrock274.type.Link[] links)
    {
        this.uuid = uuid;
