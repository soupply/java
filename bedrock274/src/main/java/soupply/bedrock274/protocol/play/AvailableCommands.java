...
public class AvailableCommands extends soupply.bedrock274.Packet
{
    ...
    public soupply.bedrock274.type.Enum[] enums;
    public soupply.bedrock274.type.Command[] commands;

    public AvailableCommands()
    {
    }

    public AvailableCommands(String[] enumValues, String[] unknown1, soupply.bedrock274.type.Enum[] enums, soupply.bedrock274.type.Command[] commands)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Enum z5bm:enums)
        {
            z5bm.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)commands.length);
        for(soupply.bedrock274.type.Command y9bfzm:commands)
        {
