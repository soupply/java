...
public class ClientboundMapItemData extends soupply.bedrock274.Packet
{
    ...
    public IntXZ offset;
    public byte[] data;
    public soupply.bedrock274.type.Decoration[] decorations;
    ...
    public ClientboundMapItemData(long mapId, int update, byte scale, IntXZ size, IntXZ offset, byte[] data, soupply.bedrock274.type.Decoration[] decorations)
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        if(update==4)
        {
            ...
            for(soupply.bedrock274.type.Decoration zvbjdlbm:decorations)
            {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        if(update==4)
        {
            ...
            decorations = new soupply.bedrock274.type.Decoration[bry9yrb5];
