...
public class CommandOutput extends soupply.bedrock274.Packet
{

    public static final int ID = 79;

    public soupply.bedrock274.type.CommandOriginData originData;
    public byte outputType;
    public int successCount;
    public soupply.bedrock274.type.CommandMessage[] messages;
    public String unknown4;

    public CommandOutput()
    {
        this.originData = new soupply.bedrock274.type.CommandOriginData();
    }

    public CommandOutput(soupply.bedrock274.type.CommandOriginData originData, byte outputType, int successCount, soupply.bedrock274.type.CommandMessage[] messages, String unknown4)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.CommandMessage bvcfzm:messages)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        messages = new soupply.bedrock274.type.CommandMessage[b1cnzv];
