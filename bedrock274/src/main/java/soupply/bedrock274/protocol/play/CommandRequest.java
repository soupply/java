...
public class CommandRequest extends soupply.bedrock274.Packet
{
    ...
    public CommandRequest(String command, int type, soupply.bedrock274.type.McpeUuid uuid, String requestId, int playerId, boolean internal)
    {
