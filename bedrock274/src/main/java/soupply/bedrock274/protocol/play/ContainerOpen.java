...
public class ContainerOpen extends soupply.bedrock274.Packet
{
    ...
    public ContainerOpen(byte window, byte type, soupply.bedrock274.type.BlockPosition position, long entityId)
    {
        this.window = window;
        this.type = type;
