...
public class CraftingEvent extends soupply.bedrock274.Packet
{
    ...
    public byte window;
    public int type;
    public soupply.bedrock274.type.McpeUuid uuid;
    public soupply.bedrock274.type.Slot[] input;
    public soupply.bedrock274.type.Slot[] output;

    public CraftingEvent()
    {
        this.uuid = new soupply.bedrock274.type.McpeUuid();
    }

    public CraftingEvent(byte window, int type, soupply.bedrock274.type.McpeUuid uuid, soupply.bedrock274.type.Slot[] input, soupply.bedrock274.type.Slot[] output)
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Slot a5dq:input)
        {
            a5dq.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)output.length);
        for(soupply.bedrock274.type.Slot bvcv:output)
        {
