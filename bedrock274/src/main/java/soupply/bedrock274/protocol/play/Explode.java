...
public class Explode extends soupply.bedrock274.Packet
{
    ...
    public float radius;
    public soupply.bedrock274.type.BlockPosition[] destroyedBlocks;
    ...
    public Explode(FloatXYZ position, float radius, soupply.bedrock274.type.BlockPosition[] destroyedBlocks)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.BlockPosition zvdjevqx:destroyedBlocks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        destroyedBlocks = new soupply.bedrock274.type.BlockPosition[brcrblzj];
