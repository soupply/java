...
public class FullChunkData extends soupply.bedrock274.Packet
{

    public static final int ID = 58;

    public IntXZ position;
    public soupply.bedrock274.type.ChunkData data;

    public FullChunkData()
    {
        this.position = new IntXZ();
        this.data = new soupply.bedrock274.type.ChunkData();
    }

    public FullChunkData(IntXZ position, soupply.bedrock274.type.ChunkData data)
    {
