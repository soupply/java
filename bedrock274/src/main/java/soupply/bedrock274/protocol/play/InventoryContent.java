...
public class InventoryContent extends soupply.bedrock274.Packet
{

    public static final int ID = 49;

    public int window;
    public soupply.bedrock274.type.Slot[] slots;

    public InventoryContent()
    {
    }

    public InventoryContent(int window, soupply.bedrock274.type.Slot[] slots)
    {
        this.window = window;
        this.slots = slots;
    }
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Slot cxdm:slots)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        slots = new soupply.bedrock274.type.Slot[bnbr];
