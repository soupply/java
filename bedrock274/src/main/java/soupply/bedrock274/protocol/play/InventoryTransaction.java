...
public class InventoryTransaction extends soupply.bedrock274.Packet
{

    public static final int ID = 30;

    public int type;
    public soupply.bedrock274.type.InventoryAction[] actions;

    public InventoryTransaction()
    {
    }

    public InventoryTransaction(int type, soupply.bedrock274.type.InventoryAction[] actions)
    {
        this.type = type;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.InventoryAction yna9c:actions)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        actions = new soupply.bedrock274.type.InventoryAction[bfdlbm];
    ...
    public class UseItem extends Type
    {
        ...
        public soupply.bedrock274.type.BlockPosition blockPosition;
        public int face;
        ...
        public UseItem()
        {
            this.blockPosition = new soupply.bedrock274.type.BlockPosition();
            this.item = new soupply.bedrock274.type.Slot();
            this.playerPosition = new FloatXYZ();
            this.clickPosition = new FloatXYZ();
        }

        public UseItem(int actionType, soupply.bedrock274.type.BlockPosition blockPosition, int face, int hotbarSlot, soupply.bedrock274.type.Slot item, FloatXYZ playerPosition, FloatXYZ clickPosition)
        {
    ...
    public class UseItemOnEntity extends Type
    {
        ...
        public UseItemOnEntity(long entityId, int actionType, int hotbarSlot, soupply.bedrock274.type.Slot item, FloatXYZ unknown4, FloatXYZ unknown5)
        {
    ...
    public class ReleaseItem extends Type
    {
        ...
        public ReleaseItem(int actionType, int hotbarSlot, soupply.bedrock274.type.Slot item, FloatXYZ headPosition)
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
