...
public class Login extends soupply.bedrock274.Packet
{

    public static final int ID = 1;

    public int protocol = 274;
    public soupply.bedrock274.type.LoginBody body;

    public Login()
    {
        this.body = new soupply.bedrock274.type.LoginBody();
    }

    public Login(int protocol, soupply.bedrock274.type.LoginBody body)
    {
