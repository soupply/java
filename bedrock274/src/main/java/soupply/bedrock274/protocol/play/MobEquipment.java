...
public class MobEquipment extends soupply.bedrock274.Packet
{
    ...
    public MobEquipment(long entityId, soupply.bedrock274.type.Slot item, byte inventorySlot, byte hotbarSlot, byte unknown4)
    {
