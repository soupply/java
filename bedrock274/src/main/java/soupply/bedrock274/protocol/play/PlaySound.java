...
public class PlaySound extends soupply.bedrock274.Packet
{
    ...
    public PlaySound(String name, soupply.bedrock274.type.BlockPosition position, float volume, float pitch)
    {
        this.name = name;
