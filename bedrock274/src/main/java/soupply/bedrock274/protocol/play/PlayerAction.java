...
public class PlayerAction extends soupply.bedrock274.Packet
{
    ...
    public PlayerAction(long entityId, int action, soupply.bedrock274.type.BlockPosition position, int face)
    {
