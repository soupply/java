...
public class ResourcePacksInfo extends soupply.bedrock274.Packet
{

    public static final int ID = 6;

    public boolean mustAccept;
    public soupply.bedrock274.type.PackWithSize[] behaviourPacks;
    public soupply.bedrock274.type.PackWithSize[] resourcePacks;

    public ResourcePacksInfo()
    {
    }

    public ResourcePacksInfo(boolean mustAccept, soupply.bedrock274.type.PackWithSize[] behaviourPacks, soupply.bedrock274.type.PackWithSize[] resourcePacks)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.PackWithSize yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeLittleEndianShort((short)resourcePacks.length);
        for(soupply.bedrock274.type.PackWithSize cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        behaviourPacks = new soupply.bedrock274.type.PackWithSize[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock274.type.PackWithSize[bjc9cnuf];
