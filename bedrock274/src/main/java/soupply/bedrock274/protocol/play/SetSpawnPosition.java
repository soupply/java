...
public class SetSpawnPosition extends soupply.bedrock274.Packet
{
    ...
    public SetSpawnPosition(int type, soupply.bedrock274.type.BlockPosition position, boolean forced)
    {
        this.type = type;
