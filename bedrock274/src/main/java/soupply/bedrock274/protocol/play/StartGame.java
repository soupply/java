...
public class StartGame extends soupply.bedrock274.Packet
{
    ...
    public soupply.bedrock274.type.Rule[] gameRules;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Rule zfzjbv:gameRules)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        gameRules = new soupply.bedrock274.type.Rule[bdbvdxc];
