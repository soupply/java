...
public class UpdateBlock extends soupply.bedrock274.Packet
{
    ...
    public UpdateBlock(soupply.bedrock274.type.BlockPosition position, int block, int flagsAndMeta, int dataLayerId)
    {
