...
public class UpdateBlockSynced extends soupply.bedrock274.Packet
{
    ...
    public UpdateBlockSynced(soupply.bedrock274.type.BlockPosition position, int block, int flagsAndMeta, long entityId, long unknown4)
    {
