...
public class ChunkData extends Type
{
    ...
    public soupply.bedrock274.type.Section[] sections;
    public short[] heights;
    public byte[] biomes;
    public byte[] borders;
    public soupply.bedrock274.type.ExtraData[] extraData;
    ...
    public ChunkData(soupply.bedrock274.type.Section[] sections, short[] heights, byte[] biomes, byte[] borders, soupply.bedrock274.type.ExtraData[] extraData, byte[] blockEntities)
    {
    ...
    private void encodeBodyImpl(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Section cvdlbm:sections)
        {
        ...
        for(soupply.bedrock274.type.ExtraData zhcfyr:extraData)
        {
    ...
    private void decodeBodyImpl(Buffer _buffer) throws DecodeException
    {
        ...
        sections = new soupply.bedrock274.type.Section[bnyrb5];
        ...
        extraData = new soupply.bedrock274.type.ExtraData[bvdjrfy];
