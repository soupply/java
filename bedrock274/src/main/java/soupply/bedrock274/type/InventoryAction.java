...
public class InventoryAction extends Type
{
    ...
    public int unknown2;
    public int slot;
    public soupply.bedrock274.type.Slot oldItem;
    public soupply.bedrock274.type.Slot newItem;

    public InventoryAction()
    {
        this.oldItem = new soupply.bedrock274.type.Slot();
        this.newItem = new soupply.bedrock274.type.Slot();
    }

    public InventoryAction(int source, int container, int unknown2, int slot, soupply.bedrock274.type.Slot oldItem, soupply.bedrock274.type.Slot newItem)
    {
        this.source = source;
