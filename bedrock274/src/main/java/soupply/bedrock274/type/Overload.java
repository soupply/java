...
public class Overload extends Type
{
    ...
    public soupply.bedrock274.type.Parameter[] parameters;

    public Overload()
    {
    }

    public Overload(soupply.bedrock274.type.Parameter[] parameters)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock274.type.Parameter cfy1dvc:parameters)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        parameters = new soupply.bedrock274.type.Parameter[bbcfzrcm];
