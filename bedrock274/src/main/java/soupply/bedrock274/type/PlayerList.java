...
public class PlayerList extends Type
{
    ...
    public soupply.bedrock274.type.Skin skin;
    public String unknown4;

    public PlayerList()
    {
        this.uuid = new soupply.bedrock274.type.McpeUuid();
        this.skin = new soupply.bedrock274.type.Skin();
    }

    public PlayerList(soupply.bedrock274.type.McpeUuid uuid, long entityId, String displayName, soupply.bedrock274.type.Skin skin, String unknown4)
    {
        this.uuid = uuid;
