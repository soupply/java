...
public class AddEntity extends soupply.bedrock282.Packet
{
    ...
    public soupply.bedrock282.type.Attribute[] attributes;
    ...
    public AddEntity(long entityId, long runtimeId, int type, FloatXYZ position, FloatXYZ motion, float pitch, float yaw, float headYaw, soupply.bedrock282.type.Attribute[] attributes, soupply.bedrock282.metadata.Metadata metadata, soupply.bedrock282.type.Link[] links)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Attribute yrcldrc:attributes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        attributes = new soupply.bedrock282.type.Attribute[bfdjyvzm];
