...
public class AddHangingEntity extends soupply.bedrock282.Packet
{
    ...
    public AddHangingEntity(long entityId, long runtimeId, soupply.bedrock282.type.BlockPosition position, int unknown3)
    {
