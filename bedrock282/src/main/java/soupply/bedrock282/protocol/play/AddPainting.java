...
public class AddPainting extends soupply.bedrock282.Packet
{
    ...
    public AddPainting(long entityId, long runtimeId, soupply.bedrock282.type.BlockPosition position, int direction, String title)
    {
