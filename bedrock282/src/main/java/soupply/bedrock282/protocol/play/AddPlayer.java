...
public class AddPlayer extends soupply.bedrock282.Packet
{

    public static final int ID = 12;

    public soupply.bedrock282.type.McpeUuid uuid;
    ...
    public float yaw;
    public soupply.bedrock282.type.Slot heldItem;
    public soupply.bedrock282.metadata.Metadata metadata;
    ...
    public soupply.bedrock282.type.Link[] links;
    public String deviceId;

    public AddPlayer()
    {
        this.uuid = new soupply.bedrock282.type.McpeUuid();
        this.position = new FloatXYZ();
        this.motion = new FloatXYZ();
        this.heldItem = new soupply.bedrock282.type.Slot();
        this.metadata = new soupply.bedrock282.metadata.Metadata();
    }

    public AddPlayer(soupply.bedrock282.type.McpeUuid uuid, String username, long entityId, long runtimeId, FloatXYZ position, FloatXYZ motion, float pitch, float headYaw, float yaw, soupply.bedrock282.type.Slot heldItem, soupply.bedrock282.metadata.Metadata metadata, int unknown11, int unknown12, int unknown13, int unknown14, int unknown15, long unknown16, soupply.bedrock282.type.Link[] links, String deviceId)
    {
        this.uuid = uuid;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Link blam:links)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        links = new soupply.bedrock282.type.Link[bxbt];
