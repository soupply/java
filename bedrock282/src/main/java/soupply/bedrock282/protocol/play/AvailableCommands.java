...
public class AvailableCommands extends soupply.bedrock282.Packet
{
    ...
    public soupply.bedrock282.type.Enum[] enums;
    public soupply.bedrock282.type.Command[] commands;

    public AvailableCommands()
    {
    }

    public AvailableCommands(String[] enumValues, String[] unknown1, soupply.bedrock282.type.Enum[] enums, soupply.bedrock282.type.Command[] commands)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Enum z5bm:enums)
        {
            z5bm.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)commands.length);
        for(soupply.bedrock282.type.Command y9bfzm:commands)
        {
