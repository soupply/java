...
public class ClientboundMapItemData extends soupply.bedrock282.Packet
{
    ...
    public IntXZ offset;
    public byte[] data;
    public soupply.bedrock282.type.Decoration[] decorations;
    ...
    public ClientboundMapItemData(long mapId, int update, byte scale, IntXZ size, IntXZ offset, byte[] data, soupply.bedrock282.type.Decoration[] decorations)
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        if(update==4)
        {
            ...
            for(soupply.bedrock282.type.Decoration zvbjdlbm:decorations)
            {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        if(update==4)
        {
            ...
            decorations = new soupply.bedrock282.type.Decoration[bry9yrb5];
