...
public class CommandBlockUpdate extends soupply.bedrock282.Packet
{
    ...
    public CommandBlockUpdate(boolean updateBlock, soupply.bedrock282.type.BlockPosition position, int mode, boolean redstoneMode, boolean conditional, long minecart, String command, String lastOutput, String hover, boolean trackOutput)
    {
