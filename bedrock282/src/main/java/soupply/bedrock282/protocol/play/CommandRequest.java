...
public class CommandRequest extends soupply.bedrock282.Packet
{
    ...
    public CommandRequest(String command, int type, soupply.bedrock282.type.McpeUuid uuid, String requestId, int playerId, boolean internal)
    {
