...
public class ContainerOpen extends soupply.bedrock282.Packet
{
    ...
    public ContainerOpen(byte window, byte type, soupply.bedrock282.type.BlockPosition position, long entityId)
    {
        this.window = window;
        this.type = type;
