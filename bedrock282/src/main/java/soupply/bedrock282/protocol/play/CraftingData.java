...
public class CraftingData extends soupply.bedrock282.Packet
{

    public static final int ID = 52;

    public soupply.bedrock282.type.Recipe[] recipes;

    public CraftingData()
    {
    }

    public CraftingData(soupply.bedrock282.type.Recipe[] recipes)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Recipe cvabc:recipes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        recipes = new soupply.bedrock282.type.Recipe[bjylzm];
