...
public class CraftingEvent extends soupply.bedrock282.Packet
{
    ...
    public soupply.bedrock282.type.Slot[] input;
    public soupply.bedrock282.type.Slot[] output;
    ...
    public CraftingEvent(byte window, int type, soupply.bedrock282.type.McpeUuid uuid, soupply.bedrock282.type.Slot[] input, soupply.bedrock282.type.Slot[] output)
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Slot a5dq:input)
        {
            a5dq.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)output.length);
        for(soupply.bedrock282.type.Slot bvcv:output)
        {
