...
public class Explode extends soupply.bedrock282.Packet
{
    ...
    public float radius;
    public soupply.bedrock282.type.BlockPosition[] destroyedBlocks;
    ...
    public Explode(FloatXYZ position, float radius, soupply.bedrock282.type.BlockPosition[] destroyedBlocks)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.BlockPosition zvdjevqx:destroyedBlocks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        destroyedBlocks = new soupply.bedrock282.type.BlockPosition[brcrblzj];
