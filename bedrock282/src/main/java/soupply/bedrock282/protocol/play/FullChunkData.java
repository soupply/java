...
public class FullChunkData extends soupply.bedrock282.Packet
{

    public static final int ID = 58;

    public IntXZ position;
    public soupply.bedrock282.type.ChunkData data;

    public FullChunkData()
    {
        this.position = new IntXZ();
        this.data = new soupply.bedrock282.type.ChunkData();
    }

    public FullChunkData(IntXZ position, soupply.bedrock282.type.ChunkData data)
    {
