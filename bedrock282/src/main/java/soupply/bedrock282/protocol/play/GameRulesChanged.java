...
public class GameRulesChanged extends soupply.bedrock282.Packet
{

    public static final int ID = 72;

    public soupply.bedrock282.type.Rule[] rules;

    public GameRulesChanged()
    {
    }

    public GameRulesChanged(soupply.bedrock282.type.Rule[] rules)
    {
        this.rules = rules;
    }
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Rule cvzm:rules)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        rules = new soupply.bedrock282.type.Rule[bjbv];
