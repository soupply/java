...
public class InventoryContent extends soupply.bedrock282.Packet
{

    public static final int ID = 49;

    public int window;
    public soupply.bedrock282.type.Slot[] slots;

    public InventoryContent()
    {
    }

    public InventoryContent(int window, soupply.bedrock282.type.Slot[] slots)
    {
        this.window = window;
        this.slots = slots;
    }
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Slot cxdm:slots)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        slots = new soupply.bedrock282.type.Slot[bnbr];
