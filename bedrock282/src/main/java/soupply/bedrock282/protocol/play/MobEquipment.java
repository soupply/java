...
public class MobEquipment extends soupply.bedrock282.Packet
{
    ...
    public MobEquipment(long entityId, soupply.bedrock282.type.Slot item, byte inventorySlot, byte hotbarSlot, byte unknown4)
    {
