...
public class PlaySound extends soupply.bedrock282.Packet
{
    ...
    public PlaySound(String name, soupply.bedrock282.type.BlockPosition position, float volume, float pitch)
    {
        this.name = name;
