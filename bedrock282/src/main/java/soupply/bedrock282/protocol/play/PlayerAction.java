...
public class PlayerAction extends soupply.bedrock282.Packet
{
    ...
    public PlayerAction(long entityId, int action, soupply.bedrock282.type.BlockPosition position, int face)
    {
