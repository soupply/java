...
public class PlayerList extends soupply.bedrock282.Packet
{
    ...
    public class Add extends Type
    {
        ...
        public soupply.bedrock282.type.PlayerList[] players;

        public Add()
        {
        }

        public Add(soupply.bedrock282.type.PlayerList[] players)
        {
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            for(soupply.bedrock282.type.PlayerList cxevc:players)
            {
        ...
        public void decodeBody(Buffer _buffer) throws DecodeException
        {
            ...
            players = new soupply.bedrock282.type.PlayerList[bbylcm];
    ...
    public class Remove extends Type
    {
        ...
        public soupply.bedrock282.type.McpeUuid[] players;

        public Remove()
        {
        }

        public Remove(soupply.bedrock282.type.McpeUuid[] players)
        {
            this.players = players;
        }
        ...
        public void encodeBody(Buffer _buffer)
        {
            ...
            encodeMainBody(_buffer);
            _buffer.writeVaruint((int)players.length);
            for(soupply.bedrock282.type.McpeUuid cxevc:players)
            {
                cxevc.encodeBody(_buffer);
            }
        }
        ...
        {
            final int bbylcm = _buffer.readVaruint();
            players = new soupply.bedrock282.type.McpeUuid[bbylcm];
            for(int cxevc=0;cxevc<players.length;cxevc++)
            {
                players[cxevc].decodeBody(_buffer);
            }
