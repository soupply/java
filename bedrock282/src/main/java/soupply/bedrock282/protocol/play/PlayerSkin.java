...
public class PlayerSkin extends soupply.bedrock282.Packet
{
    ...
    public PlayerSkin(soupply.bedrock282.type.McpeUuid uuid, String skinId, String skinName, String unknown3, byte[] skinData, byte[] capeData, String geometryModel, byte[] geometryData)
    {
        this.uuid = uuid;
        this.skinId = skinId;
