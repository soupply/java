...
public class ResourcePacksStackPacket extends soupply.bedrock282.Packet
{

    public static final int ID = 7;

    public boolean mustAccept;
    public soupply.bedrock282.type.Pack[] behaviourPacks;
    public soupply.bedrock282.type.Pack[] resourcePacks;

    public ResourcePacksStackPacket()
    {
    }

    public ResourcePacksStackPacket(boolean mustAccept, soupply.bedrock282.type.Pack[] behaviourPacks, soupply.bedrock282.type.Pack[] resourcePacks)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Pack yvyzbvuf:behaviourPacks)
        {
            yvyzbvuf.encodeBody(_buffer);
        }
        _buffer.writeVaruint((int)resourcePacks.length);
        for(soupply.bedrock282.type.Pack cvbvyvyn:resourcePacks)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        behaviourPacks = new soupply.bedrock282.type.Pack[bjafa9cb];
        ...
        resourcePacks = new soupply.bedrock282.type.Pack[bjc9cnuf];
