...
public class SetScore extends soupply.bedrock282.Packet
{
    ...
    public byte type;
    public soupply.bedrock282.type.Score[] scores;

    public SetScore()
    {
    }

    public SetScore(byte type, soupply.bedrock282.type.Score[] scores)
    {
        this.type = type;
        this.scores = scores;
    }
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Score cncv:scores)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        scores = new soupply.bedrock282.type.Score[bnbjc];
