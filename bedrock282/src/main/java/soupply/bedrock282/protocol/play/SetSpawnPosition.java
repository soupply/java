...
public class SetSpawnPosition extends soupply.bedrock282.Packet
{
    ...
    public SetSpawnPosition(int type, soupply.bedrock282.type.BlockPosition position, boolean forced)
    {
        this.type = type;
