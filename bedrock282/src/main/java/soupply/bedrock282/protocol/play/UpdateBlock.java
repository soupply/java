...
public class UpdateBlock extends soupply.bedrock282.Packet
{
    ...
    public UpdateBlock(soupply.bedrock282.type.BlockPosition position, int block, int flagsAndMeta, int dataLayerId)
    {
