...
public class UpdateBlockSynced extends soupply.bedrock282.Packet
{
    ...
    public UpdateBlockSynced(soupply.bedrock282.type.BlockPosition position, int block, int flagsAndMeta, long entityId, long unknown4)
    {
