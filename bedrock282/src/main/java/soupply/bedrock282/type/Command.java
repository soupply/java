...
public class Command extends Type
{
    ...
    public soupply.bedrock282.type.Overload[] overloads;

    public Command()
    {
    }

    public Command(String name, String description, byte unknown2, byte permissionLevel, int aliasesEnum, soupply.bedrock282.type.Overload[] overloads)
    {
        this.name = name;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.bedrock282.type.Overload bzcxyr:overloads)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        overloads = new soupply.bedrock282.type.Overload[b9zjbfc];
