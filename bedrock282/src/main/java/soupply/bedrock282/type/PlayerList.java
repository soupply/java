...
public class PlayerList extends Type
{
    ...
    public soupply.bedrock282.type.Skin skin;
    public String unknown4;

    public PlayerList()
    {
        this.uuid = new soupply.bedrock282.type.McpeUuid();
        this.skin = new soupply.bedrock282.type.Skin();
    }

    public PlayerList(soupply.bedrock282.type.McpeUuid uuid, long entityId, String displayName, soupply.bedrock282.type.Skin skin, String unknown4)
    {
        this.uuid = uuid;
