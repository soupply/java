...
public class Metadata extends HashMap<Byte, MetadataValue>
{
    ...
    public soupply.java.type.OptionalChat getCustomName()
    {
    ...
    public void setCustomName(soupply.java.type.OptionalChat _value)
    {
        MetadataValue value = this.get(2);
    ...
    public soupply.java.type.Slot getPotion()
    {
    ...
    public void setPotion(soupply.java.type.Slot _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java.type.Particle getParticle()
    {
    ...
    public void setParticle(soupply.java.type.Particle _value)
    {
        MetadataValue value = this.get(9);
    ...
    public soupply.java.type.OptionalPosition getBeamTarget()
    {
        MetadataValue value = this.get(6);
    ...
    public void setBeamTarget(soupply.java.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java.type.Slot getFirework()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setFirework(soupply.java.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public soupply.java.type.Slot getItem()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setItem(soupply.java.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public soupply.java.type.OptionalUuid getOwnerUuid()
    {
        MetadataValue value = this.get(14);
    ...
    public void setOwnerUuid(soupply.java.type.OptionalUuid _value)
    {
        MetadataValue value = this.get(14);
    ...
    public soupply.java.type.OptionalPosition getShulkerAttachment()
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) return ((MetadataOptionalPosition)value).value;
        else return null;
    ...
    public void setShulkerAttachment(soupply.java.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) ((MetadataOptionalPosition)value).value = _value;
