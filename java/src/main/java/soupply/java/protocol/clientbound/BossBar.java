...
public class BossBar extends soupply.java.Packet
{
    ...
    public class Add extends soupply.java.Packet
    {
    ...
    public class Remove extends soupply.java.Packet
    {
    ...
    public class UpdateTitle extends soupply.java.Packet
    {
    ...
    public class UpdateStyle extends soupply.java.Packet
    {
    ...
    public class UpdateFlags extends soupply.java.Packet
    {
