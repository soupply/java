...
public class CombatEvent extends soupply.java.Packet
{
    ...
    public class EnterCombat extends soupply.java.Packet
    {
    ...
    public class EndCombat extends soupply.java.Packet
    {
    ...
    public class EntityDead extends soupply.java.Packet
    {
