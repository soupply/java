...
public class Title extends soupply.java.Packet
{
    ...
    public class SetTitle extends soupply.java.Packet
    {
    ...
    public class SetSubtitle extends soupply.java.Packet
    {
    ...
    public class SetActionBar extends soupply.java.Packet
    {
    ...
    public class SetTimings extends soupply.java.Packet
    {
    ...
    public class Hide extends soupply.java.Packet
    {
    ...
    public class Reset extends soupply.java.Packet
    {
