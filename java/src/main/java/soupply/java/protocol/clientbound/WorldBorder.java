...
public class WorldBorder extends soupply.java.Packet
{
    ...
    public class SetSize extends soupply.java.Packet
    {
    ...
    public class LerpSize extends soupply.java.Packet
    {
    ...
    public class SetCenter extends soupply.java.Packet
    {
    ...
    public class Initialize extends soupply.java.Packet
    {
    ...
    public class SetWarningTime extends soupply.java.Packet
    {
    ...
    public class SetWarningBlocks extends soupply.java.Packet
    {
