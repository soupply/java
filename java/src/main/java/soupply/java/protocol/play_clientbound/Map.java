...
public class Map extends soupply.java.Packet
{
    ...
    public soupply.java.type.Icon[] icons;
    public byte colums;
    public byte rows;
    ...
    public Map(int mapId, byte scale, boolean showIcons, soupply.java.type.Icon[] icons, byte colums, byte rows, ByteXZ offset, byte[] data)
    {
        this.mapId = mapId;
        this.scale = scale;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java.type.Icon anbm:icons)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        icons = new soupply.java.type.Icon[blb5];
