...
public class TabComplete extends soupply.java.Packet
{
    ...
    public int start;
    public int end;
    public soupply.java.type.Match[] matches;

    public TabComplete()
    {
    }

    public TabComplete(int transactionId, int start, int end, soupply.java.type.Match[] matches)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java.type.Match bfyhc:matches)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        matches = new soupply.java.type.Match[b1dnzm];
