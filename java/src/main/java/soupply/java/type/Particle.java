...
public class Particle extends Type
{
    ...
    public soupply.java.type.Slot dataSlot;

    public Particle()
    {
        this.dataSlot = new soupply.java.type.Slot();
    }

    public Particle(int id, int dataVaruint, float dataFloat, soupply.java.type.Slot dataSlot)
    {
        this.id = id;
