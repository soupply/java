...
public class CombatEvent extends soupply.java210.Packet
{
    ...
    public class EnterCombat extends soupply.java210.Packet
    {
    ...
    public class EndCombat extends soupply.java210.Packet
    {
    ...
    public class EntityDead extends soupply.java210.Packet
    {
