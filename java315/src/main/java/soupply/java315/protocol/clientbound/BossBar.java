...
public class BossBar extends soupply.java315.Packet
{
    ...
    public class Add extends soupply.java315.Packet
    {
    ...
    public class Remove extends soupply.java315.Packet
    {
    ...
    public class UpdateTitle extends soupply.java315.Packet
    {
    ...
    public class UpdateStyle extends soupply.java315.Packet
    {
    ...
    public class UpdateFlags extends soupply.java315.Packet
    {
