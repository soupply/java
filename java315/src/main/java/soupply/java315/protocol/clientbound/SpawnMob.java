...
public class SpawnMob extends soupply.java315.Packet
{
    ...
    public soupply.java315.metadata.Metadata metadata;
    ...
    public SpawnMob()
    {
        ...
        this.metadata = new soupply.java315.metadata.Metadata();
    }

    public SpawnMob(int entityId, UUID uuid, int type, DoubleXYZ position, byte yaw, byte pitch, byte headPitch, ShortXYZ velocity, soupply.java315.metadata.Metadata metadata)
    {
