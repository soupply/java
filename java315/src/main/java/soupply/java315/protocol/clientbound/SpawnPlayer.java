...
public class SpawnPlayer extends soupply.java315.Packet
{
    ...
    public SpawnPlayer(int entityId, UUID uuid, DoubleXYZ position, byte yaw, byte pitch, soupply.java315.metadata.Metadata metadata)
    {
