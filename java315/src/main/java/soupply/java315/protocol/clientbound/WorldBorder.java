...
public class WorldBorder extends soupply.java315.Packet
{
    ...
    public class SetSize extends soupply.java315.Packet
    {
    ...
    public class LerpSize extends soupply.java315.Packet
    {
    ...
    public class SetCenter extends soupply.java315.Packet
    {
    ...
    public class Initialize extends soupply.java315.Packet
    {
    ...
    public class SetWarningTime extends soupply.java315.Packet
    {
    ...
    public class SetWarningBlocks extends soupply.java315.Packet
    {
