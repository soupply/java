...
public class SpawnMob extends soupply.java316.Packet
{
    ...
    public SpawnMob(int entityId, UUID uuid, int type, DoubleXYZ position, byte yaw, byte pitch, byte headPitch, ShortXYZ velocity, soupply.java316.metadata.Metadata metadata)
    {
