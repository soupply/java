...
public class Title extends soupply.java316.Packet
{
    ...
    public class SetTitle extends soupply.java316.Packet
    {
    ...
    public class SetSubtitle extends soupply.java316.Packet
    {
    ...
    public class SetActionBar extends soupply.java316.Packet
    {
    ...
    public class SetTimings extends soupply.java316.Packet
    {
    ...
    public class Hide extends soupply.java316.Packet
    {
    ...
    public class Reset extends soupply.java316.Packet
    {
