...
public class Metadata extends HashMap<Byte, MetadataValue>
{
    ...
    public soupply.java335.type.Slot getPotion()
    {
    ...
    public void setPotion(soupply.java335.type.Slot _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java335.type.OptionalPosition getBeamTarget()
    {
        MetadataValue value = this.get(6);
    ...
    public void setBeamTarget(soupply.java335.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java335.type.Slot getFirework()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setFirework(soupply.java335.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public soupply.java335.type.Slot getItem()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setItem(soupply.java335.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public soupply.java335.type.OptionalUuid getOwnerUuid()
    {
        MetadataValue value = this.get(14);
    ...
    public void setOwnerUuid(soupply.java335.type.OptionalUuid _value)
    {
        MetadataValue value = this.get(14);
    ...
    public soupply.java335.type.OptionalPosition getShulkerAttachment()
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) return ((MetadataOptionalPosition)value).value;
        else return null;
    ...
    public void setShulkerAttachment(soupply.java335.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) ((MetadataOptionalPosition)value).value = _value;
