...
public class CombatEvent extends soupply.java335.Packet
{
    ...
    public class EnterCombat extends soupply.java335.Packet
    {
    ...
    public class EndCombat extends soupply.java335.Packet
    {
    ...
    public class EntityDead extends soupply.java335.Packet
    {
