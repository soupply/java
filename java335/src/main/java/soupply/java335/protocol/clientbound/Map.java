...
public class Map extends soupply.java335.Packet
{
    ...
    public soupply.java335.type.Icon[] icons;
    public byte colums;
    public byte rows;
    ...
    public Map(int mapId, byte scale, boolean showIcons, soupply.java335.type.Icon[] icons, byte colums, byte rows, ByteXZ offset, byte[] data)
    {
        this.mapId = mapId;
        this.scale = scale;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java335.type.Icon anbm:icons)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        icons = new soupply.java335.type.Icon[blb5];
