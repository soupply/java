...
public class SpawnMob extends soupply.java335.Packet
{
    ...
    public SpawnMob(int entityId, UUID uuid, int type, DoubleXYZ position, byte yaw, byte pitch, byte headPitch, ShortXYZ velocity, soupply.java335.metadata.Metadata metadata)
    {
