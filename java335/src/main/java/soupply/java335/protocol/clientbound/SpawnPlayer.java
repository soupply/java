...
public class SpawnPlayer extends soupply.java335.Packet
{
    ...
    public SpawnPlayer(int entityId, UUID uuid, DoubleXYZ position, byte yaw, byte pitch, soupply.java335.metadata.Metadata metadata)
    {
