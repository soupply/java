...
public class Teams extends soupply.java335.Packet
{
    ...
    public class CreateTeam extends soupply.java335.Packet
    {
    ...
    public class RemoveTeam extends soupply.java335.Packet
    {
    ...
    public class UpdateTeamInfo extends soupply.java335.Packet
    {
    ...
    public class AddPlayers extends soupply.java335.Packet
    {
    ...
    public class RemovePlayers extends soupply.java335.Packet
    {
