...
public class Title extends soupply.java335.Packet
{
    ...
    public class SetTitle extends soupply.java335.Packet
    {
    ...
    public class SetSubtitle extends soupply.java335.Packet
    {
    ...
    public class SetActionBar extends soupply.java335.Packet
    {
    ...
    public class SetTimings extends soupply.java335.Packet
    {
    ...
    public class Hide extends soupply.java335.Packet
    {
    ...
    public class Reset extends soupply.java335.Packet
    {
