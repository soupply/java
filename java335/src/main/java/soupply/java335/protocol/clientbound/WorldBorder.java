...
public class WorldBorder extends soupply.java335.Packet
{
    ...
    public class SetSize extends soupply.java335.Packet
    {
    ...
    public class LerpSize extends soupply.java335.Packet
    {
    ...
    public class SetCenter extends soupply.java335.Packet
    {
    ...
    public class Initialize extends soupply.java335.Packet
    {
    ...
    public class SetWarningTime extends soupply.java335.Packet
    {
    ...
    public class SetWarningBlocks extends soupply.java335.Packet
    {
