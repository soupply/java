...
public class ListAddPlayer extends Type
{
    ...
    public UUID uuid;
    public String name;
    public soupply.java335.type.Property[] properties;
    public int gamemode;
    public int latency;
    ...
    public ListAddPlayer(UUID uuid, String name, soupply.java335.type.Property[] properties, int gamemode, int latency, boolean hasDisplayName, String displayName)
    {
        this.uuid = uuid;
        this.name = name;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java335.type.Property cjcvdlc:properties)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        properties = new soupply.java335.type.Property[bbbbcrzm];
