...
public class BossBar extends soupply.java338.Packet
{
    ...
    public class Add extends soupply.java338.Packet
    {
    ...
    public class Remove extends soupply.java338.Packet
    {
    ...
    public class UpdateHealth extends soupply.java338.Packet
    {
    ...
    public class UpdateTitle extends soupply.java338.Packet
    {
    ...
    public class UpdateStyle extends soupply.java338.Packet
    {
    ...
    public class UpdateFlags extends soupply.java338.Packet
    {
