...
public class CombatEvent extends soupply.java338.Packet
{
    ...
    public class EnterCombat extends soupply.java338.Packet
    {
    ...
    public class EndCombat extends soupply.java338.Packet
    {
    ...
    public class EntityDead extends soupply.java338.Packet
    {
