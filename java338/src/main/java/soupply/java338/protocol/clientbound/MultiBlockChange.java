...
public class MultiBlockChange extends soupply.java338.Packet
{
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java338.type.BlockChange yhbdc:changes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws BufferOverflowException
    {
        ...
        changes = new soupply.java338.type.BlockChange[bny5zm];
