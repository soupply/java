...
class SpawnMob extends soupply.java338.Packet
{
    ...
    public SpawnMob(int entityId, UUID uuid, int type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, soupply.java338.Metadata metadata)
    {
