...
public class SpawnPlayer extends soupply.java338.Packet
{
    ...
    public SpawnPlayer(int entityId, UUID uuid, DoubleXYZ position, byte yaw, byte pitch, soupply.java338.metadata.Metadata metadata)
    {
