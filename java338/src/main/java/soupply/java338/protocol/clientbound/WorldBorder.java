...
public class WorldBorder extends soupply.java338.Packet
{
    ...
    public class SetSize extends soupply.java338.Packet
    {
    ...
    public class LerpSize extends soupply.java338.Packet
    {
    ...
    public class SetCenter extends soupply.java338.Packet
    {
    ...
    public class Initialize extends soupply.java338.Packet
    {
    ...
    public class SetWarningTime extends soupply.java338.Packet
    {
    ...
    public class SetWarningBlocks extends soupply.java338.Packet
    {
