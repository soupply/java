...
public class CraftingBookData extends soupply.java338.Packet
{
    ...
    public class DisplayedRecipe extends soupply.java338.Packet
    {
    ...
    public class CraftingBookStatus extends soupply.java338.Packet
    {
