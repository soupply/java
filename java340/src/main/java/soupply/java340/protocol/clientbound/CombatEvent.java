...
public class CombatEvent extends soupply.java340.Packet
{
    ...
    public class EnterCombat extends soupply.java340.Packet
    {
    ...
    public class EndCombat extends soupply.java340.Packet
    {
    ...
    public class EntityDead extends soupply.java340.Packet
    {
