...
public class Teams extends soupply.java340.Packet
{
    ...
    public class CreateTeam extends soupply.java340.Packet
    {
    ...
    public class RemoveTeam extends soupply.java340.Packet
    {
    ...
    public class UpdateTeamInfo extends soupply.java340.Packet
    {
    ...
    public class AddPlayers extends soupply.java340.Packet
    {
    ...
    public class RemovePlayers extends soupply.java340.Packet
    {
