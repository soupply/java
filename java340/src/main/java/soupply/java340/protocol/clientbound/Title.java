...
public class Title extends soupply.java340.Packet
{
    ...
    public class SetTitle extends soupply.java340.Packet
    {
    ...
    public class SetSubtitle extends soupply.java340.Packet
    {
    ...
    public class SetActionBar extends soupply.java340.Packet
    {
    ...
    public class SetTimings extends soupply.java340.Packet
    {
    ...
    public class Hide extends soupply.java340.Packet
    {
    ...
    public class Reset extends soupply.java340.Packet
    {
