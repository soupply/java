...
public class WorldBorder extends soupply.java340.Packet
{
    ...
    public class SetSize extends soupply.java340.Packet
    {
    ...
    public class LerpSize extends soupply.java340.Packet
    {
    ...
    public class SetCenter extends soupply.java340.Packet
    {
    ...
    public class Initialize extends soupply.java340.Packet
    {
    ...
    public class SetWarningTime extends soupply.java340.Packet
    {
    ...
    public class SetWarningBlocks extends soupply.java340.Packet
    {
