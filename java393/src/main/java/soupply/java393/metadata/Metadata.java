...
public class Metadata extends HashMap<Byte, MetadataValue>
{
    ...
    public soupply.java393.type.OptionalChat getCustomName()
    {
        MetadataValue value = this.get(2);
        if(value != null && value instanceof MetadataOptionalChat) return ((MetadataOptionalChat)value).value;
        else return null;
    }

    public void setCustomName(soupply.java393.type.OptionalChat _value)
    {
        MetadataValue value = this.get(2);
        if(value != null && value instanceof MetadataOptionalChat) ((MetadataOptionalChat)value).value = _value;
        else this.add(new MetadataOptionalChat((byte)2, _value));
    }
    ...
    public void setCustomNameVisible(boolean _value)
    {
        MetadataValue value = this.get(3);
    ...
    public soupply.java393.type.Slot getPotion()
    {
    ...
    public void setPotion(soupply.java393.type.Slot _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java393.type.Particle getParticle()
    {
        MetadataValue value = this.get(9);
        if(value != null && value instanceof MetadataParticle) return ((MetadataParticle)value).value;
        else return null;
    }

    public void setParticle(soupply.java393.type.Particle _value)
    {
        MetadataValue value = this.get(9);
        if(value != null && value instanceof MetadataParticle) ((MetadataParticle)value).value = _value;
        else this.add(new MetadataParticle((byte)9, _value));
    }
    ...
    public void setSplashTimer(int _value)
    {
        MetadataValue value = this.get(12);
        if(value != null && value instanceof MetadataInt) ((MetadataInt)value).value = _value;
    ...
    public soupply.java393.type.OptionalPosition getBeamTarget()
    {
        MetadataValue value = this.get(6);
    ...
    public void setBeamTarget(soupply.java393.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(6);
    ...
    public soupply.java393.type.Slot getFirework()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setFirework(soupply.java393.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public soupply.java393.type.Slot getItem()
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) return ((MetadataSlot)value).value;
        else return null;
    ...
    public void setItem(soupply.java393.type.Slot _value)
    {
        MetadataValue value = this.get(6);
        if(value != null && value instanceof MetadataSlot) ((MetadataSlot)value).value = _value;
        else this.add(new MetadataSlot((byte)6, _value));
    ...
    public void setLoyaltyLevel(int _value)
    {
        MetadataValue value = this.get(7);
        if(value != null && value instanceof MetadataInt) ((MetadataInt)value).value = _value;
        else this.add(new MetadataInt((byte)7, _value));
    ...
    public void setLeftShoulder(byte[] _value)
    {
        ...
        else this.add(new MetadataNbt((byte)15, _value));
    }
    ...
    public void setRightShoulder(byte[] _value)
    {
        MetadataValue value = this.get(16);
        if(value != null && value instanceof MetadataNbt) ((MetadataNbt)value).value = _value;
        else this.add(new MetadataNbt((byte)16, _value));
    }
    ...
    public soupply.java393.type.OptionalUuid getOwnerUuid()
    {
        MetadataValue value = this.get(14);
        if(value != null && value instanceof MetadataOptionalUuid) return ((MetadataOptionalUuid)value).value;
        else return null;
    }

    public void setOwnerUuid(soupply.java393.type.OptionalUuid _value)
    {
        MetadataValue value = this.get(14);
        if(value != null && value instanceof MetadataOptionalUuid) ((MetadataOptionalUuid)value).value = _value;
        else this.add(new MetadataOptionalUuid((byte)14, _value));
    }
    ...
    public soupply.java393.type.OptionalPosition getShulkerAttachment()
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) return ((MetadataOptionalPosition)value).value;
        else return null;
    ...
    public void setShulkerAttachment(soupply.java393.type.OptionalPosition _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataOptionalPosition) ((MetadataOptionalPosition)value).value = _value;
    ...
    public void setPhantomSize(int _value)
    {
        MetadataValue value = this.get(12);
        if(value != null && value instanceof MetadataInt) ((MetadataInt)value).value = _value;
        else this.add(new MetadataInt((byte)12, _value));
    ...
    public void setFromBucket(boolean _value)
    {
        MetadataValue value = this.get(12);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)12, _value));
    ...
    public void setPuffState(int _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataInt) ((MetadataInt)value).value = _value;
        else this.add(new MetadataInt((byte)13, _value));
    ...
    public void setTropicalFishVariant(int _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataInt) ((MetadataInt)value).value = _value;
        else this.add(new MetadataInt((byte)13, _value));
    ...
    public void setHomePosition(long _value)
    {
        MetadataValue value = this.get(13);
        if(value != null && value instanceof MetadataPosition) ((MetadataPosition)value).value = _value;
        else this.add(new MetadataPosition((byte)13, _value));
    }
    ...
    public void setHasEgg(boolean _value)
    {
        MetadataValue value = this.get(14);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)14, _value));
    ...
    public void setLayingEgg(boolean _value)
    {
        MetadataValue value = this.get(15);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)15, _value));
    ...
    public void setTravelPos(long _value)
    {
        MetadataValue value = this.get(16);
        if(value != null && value instanceof MetadataPosition) ((MetadataPosition)value).value = _value;
        else this.add(new MetadataPosition((byte)16, _value));
    }
    ...
    public void setGoingHome(boolean _value)
    {
        MetadataValue value = this.get(17);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)17, _value));
    }
    ...
    public void setTraveling(boolean _value)
    {
        MetadataValue value = this.get(18);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)18, _value));
    }
    ...
    public void setHasTarget(boolean _value)
    {
        MetadataValue value = this.get(15);
        if(value != null && value instanceof MetadataBool) ((MetadataBool)value).value = _value;
        else this.add(new MetadataBool((byte)15, _value));
