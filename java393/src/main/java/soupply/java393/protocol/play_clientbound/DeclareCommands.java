...
public class DeclareCommands extends soupply.java393.Packet
{

    public static final int ID = 17;

    public soupply.java393.type.Node[] nodes;
    ...
    public DeclareCommands(soupply.java393.type.Node[] nodes, int rootIndex)
    {
        this.nodes = nodes;
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java393.type.Node b9zm:nodes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        nodes = new soupply.java393.type.Node[b5zv];
