...
public class DeclareRecipes extends soupply.java393.Packet
{

    public static final int ID = 84;

    public soupply.java393.type.Recipe[] recipes;

    public DeclareRecipes()
    {
    }

    public DeclareRecipes(soupply.java393.type.Recipe[] recipes)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java393.type.Recipe cvabc:recipes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        recipes = new soupply.java393.type.Recipe[bjylzm];
