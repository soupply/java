...
public class EntityProperties extends soupply.java393.Packet
{

    public static final int ID = 82;

    public int entityId;
    public soupply.java393.type.Attribute[] attributes;

    public EntityProperties()
    {
    }

    public EntityProperties(int entityId, soupply.java393.type.Attribute[] attributes)
    {
    ...
    public void encodeBody(Buffer _buffer)
    {
        ...
        for(soupply.java393.type.Attribute yrcldrc:attributes)
        {
    ...
    public void decodeBody(Buffer _buffer) throws DecodeException
    {
        ...
        attributes = new soupply.java393.type.Attribute[bfdjyvzm];
