...
public class SpawnPlayer extends soupply.java393.Packet
{
    ...
    public SpawnPlayer(int entityId, UUID uuid, DoubleXYZ position, byte yaw, byte pitch, soupply.java393.metadata.Metadata metadata)
    {
