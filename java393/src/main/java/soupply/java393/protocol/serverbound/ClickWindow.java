...
public class ClickWindow extends soupply.java393.Packet
{
    ...
    public ClickWindow(byte window, short slot, byte button, short action, int mode, soupply.java393.type.Slot clickedItem)
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
